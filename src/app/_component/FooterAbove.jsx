...
<img src="hobby.png" style={{width:'35vw',marginTop:'2vw'}} alt="" />
...
<div style={{display:'flex',flexDirection:'column',alignItems:'center'
    ...
    <a href=''> <img src="Group77.png" style={{width:'4vw',paddingTop:'4vw'}} alt="" /></a>
    <a style={{fontSize:'.7vw'}}> Go to top (Ctrl+Home)</a>
</div>
</div>
<div className='pt-md-5 pt-3 pb-4'>
<img src="img99.png" style={{width:'100%'}} alt="" />
      </div>
